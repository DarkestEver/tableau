            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List</h3> <a href="index.php?pages=dashboardnew.php&pagetype=edit&grpid=<?php echo $grpid ?>"  class="box-title btn pull-right">Add new dashboard</a> 
                </div><!-- /.box-header -->
                <div class="box-body">
